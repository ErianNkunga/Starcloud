...
<br>
<h1 class="display-4"><center>Overzicht Games</center></h1>
<br>
<table class="table table-bordered border border-info">
    ...
    foreach ($allerijen as $record) {
        ...
        echo "<td>{$record['Voorraad']}</td>";
        echo "<td><form action='ARTIKEL_WIJZIGEN.php' method='post'>
            <input type='hidden' name='verstopt' value='{$record['Artikelnr']}'>
...
<center>
    <br>
    <a class= btn btn-light href= ARTIKEL_TOEVOEGEN.php role= button>Toevoegen</a>
    <br>
    <br>
